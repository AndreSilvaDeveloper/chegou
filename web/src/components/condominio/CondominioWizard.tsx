 ...
 *
 * POR QUE TRÊS PASSOS, E NÃO UM FORMULÁRIO LONGO
 *
 * São treze campos de três assuntos diferentes (o condomínio, onde ele fica, e
 * quem vai entrar). Numa coluna só, no celular, o cadastro virava uma rolagem
 * sem fim em que o erro de validação aparecia longe do campo. Cada passo valida
 * o que é dele antes de deixar avançar, então o erro chega junto do que o
 * causou.
 *
...
export function CondominioWizard({
  ...
  const submeter = (e: FormEvent) => {
    e.preventDefault();
    // Confere os três: dá para chegar ao passo 3 e voltar para apagar um campo.
