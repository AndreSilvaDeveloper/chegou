...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mesma margem do Dialog: 1rem em volta, altura em dvh para não ser
        // cortado pela barra do navegador no celular.
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("txt-secao font-semibold", className)}
    {...props}
  />
))
