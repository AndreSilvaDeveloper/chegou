...
const TRACOS = {
  ...
  /* Redes sociais (rodapé). São os traçados de MARCA do Lucide, de traço aberto
     como todos os outros daqui — não os glifos preenchidos das próprias redes.
     É deliberado: numa fileira de 20px o ícone cheio pesa muito mais que o
     vazado, e ao lado do texto do rodapé ele viraria o elemento mais escuro de
     uma linha que é secundária por definição. */
  instagram: (
    <>
