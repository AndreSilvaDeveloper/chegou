...
- `templates.ts` — textos: `retirada_confirmada`, `lembrete_codigo`,
  `sem_encomenda_pendente` (o texto de chegada é do módulo Notificações, porque
  o condomínio pode personalizar)
